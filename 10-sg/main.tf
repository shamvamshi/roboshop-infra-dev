...
resource "aws_security_group_rule" "mongodb_user" {  # it means mongodb should accept connection from user
  type              = "ingress"
  from_port         = 27017
  to_port           = 27017
  protocol          = "tcp"
...
resource "aws_security_group_rule" "payment_backend_alb" { # check _
  type              = "ingress"
  from_port         = 8080
  to_port           = 8080
  protocol          = "tcp"
